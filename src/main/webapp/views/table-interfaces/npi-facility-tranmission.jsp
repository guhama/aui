...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row clearfix">
			...
			<%@ include file="../common/table-interface-menu.jsp"%>
	...
	<script src="<c:url value="/resources/js/table-interfaces/tableInterfaceDefault.js"/>" type="text/javascript"></script>
	<script src="<c:url value="/resources/js/table-interfaces/npiFacilityTransmission.js"/>" type="text/javascript"></script>
</body>
</html>