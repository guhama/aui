...
/**
 * The Class NpiEntityTasklet. This tasklet will take a Job Execution Id and perform a merge from
 * the temporary table to the real one.
 *
 * @author crowland
 */
public class NpiEntityTasklet implements Tasklet {

  Logger logger = LoggerFactory.getLogger(NpiEntityTasklet.class);
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext)
    ...
    Map<String, Object> results = packageHandler.mergeNpiEntity(id);
